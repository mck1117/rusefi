...
TEST_F(SensorRedundant, CheckSensorsInvalid)
{
...
TEST_F(SensorRedundantIgnoreSecond, CheckSensorsInvalid)
{
	// Don't set any sensors - expect invalid
	{
		auto result = dut.get();
...
TEST_F(SensorRedundantPartialSecond, PartialRedundancy)
{
