...
void setDateTime(char * const isoDateTime) {
#if EFI_RTC
	if (strlen(isoDateTime) >= 19 && isoDateTime[10] == 'T') {
		efidatetime_t dateTime;
		isoDateTime[4] = isoDateTime[7] = isoDateTime[10] = isoDateTime[13] = isoDateTime[16] = isoDateTime[19] = '\0';
