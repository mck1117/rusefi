...
public class Fields {
	...
	public static final int acCutoffLowRpm_offset = 1496;
	public static final int acIdleRpmBump_offset = 1500;
	public static final int acRelayPin_offset = 830;
	public static final int acRelayPinMode_offset = 831;
	public static final int acSwitchAdc_offset = 1488;
	...
	public static final int afterCrankingIACtaperDuration_offset = 2056;
	...
	public static final int alternatorControl_minValue_offset = 1752;
	public static final int alternatorControl_offset = 1736;
	public static final int alternatorControl_offset_offset = 1748;
	public static final int alternatorControl_periodMs_offset = 1750;
	public static final int alternatorControl_pFactor_offset = 1736;
	...
	public static final int alternatorOffAboveTps_offset = 2048;
	public static final int alternatorOffAboveTps_offset_hex = 800;
	public static final int alternatorPwmFrequency_offset = 2276;
	public static final int analogInputDividerCoefficient_offset = 460;
	public static final int autoTuneCltThreshold_offset = 2444;
	public static final int autoTuneTpsQuietPeriod_offset = 2452;
	public static final int autoTuneTpsQuietPeriod_offset_hex = 994;
	public static final int autoTuneTpsRocThreshold_offset = 2448;
	public static final int autoTuneTpsRocThreshold_offset_hex = 990;
	public static final int AUX_DIGITAL_VALVE_COUNT = 2;
	public static final int AUX_PID_COUNT = 4;
	public static final int auxPid1_dFactor_offset = 2644;
	public static final int auxPid1_iFactor_offset = 2640;
	public static final int auxPid1_maxValue_offset = 2654;
	public static final int auxPid1_minValue_offset = 2652;
	public static final int auxPid1_offset = 2636;
	public static final int auxPid1_offset_offset = 2648;
	public static final int auxPid1_periodMs_offset = 2650;
	public static final int auxPid1_pFactor_offset = 2636;
	public static final int auxPid2_dFactor_offset = 2664;
	public static final int auxPid2_iFactor_offset = 2660;
	public static final int auxPid2_maxValue_offset = 2674;
	public static final int auxPid2_minValue_offset = 2672;
	public static final int auxPid2_offset = 2656;
	public static final int auxPid2_offset_offset = 2668;
	public static final int auxPid2_periodMs_offset = 2670;
	public static final int auxPid2_pFactor_offset = 2656;
	public static final int auxPid3_dFactor_offset = 2684;
	public static final int auxPid3_iFactor_offset = 2680;
	public static final int auxPid3_maxValue_offset = 2694;
	public static final int auxPid3_minValue_offset = 2692;
	public static final int auxPid3_offset = 2676;
	public static final int auxPid3_offset_offset = 2688;
	public static final int auxPid3_periodMs_offset = 2690;
	public static final int auxPid3_pFactor_offset = 2676;
	public static final int auxPid4_dFactor_offset = 2704;
	public static final int auxPid4_iFactor_offset = 2700;
	public static final int auxPid4_maxValue_offset = 2714;
	public static final int auxPid4_minValue_offset = 2712;
	public static final int auxPid4_offset = 2696;
	public static final int auxPid4_offset_offset = 2708;
	public static final int auxPid4_periodMs_offset = 2710;
	public static final int auxPid4_pFactor_offset = 2696;
	public static final int auxPidFrequency1_offset = 2268;
	public static final int auxPidFrequency2_offset = 2270;
	public static final int auxPidFrequency3_offset = 2272;
	public static final int auxPidFrequency4_offset = 2274;
	public static final int auxPidPins1_offset = 2240;
	public static final int auxPidPins2_offset = 2241;
	public static final int auxPidPins3_offset = 2242;
	public static final int auxPidPins4_offset = 2243;
	public static final int auxTempSensor1_adcChannel_offset = 2496;
	public static final int auxTempSensor1_alignmentFill_offset = 2497;
	public static final int auxTempSensor1_bias_resistor_offset = 2492;
	public static final int auxTempSensor1_config_offset = 2468;
	public static final int auxTempSensor1_offset = 2468;
	public static final int auxTempSensor1_resistance_1_offset = 2480;
	public static final int auxTempSensor1_resistance_2_offset = 2484;
	public static final int auxTempSensor1_resistance_3_offset = 2488;
	public static final int auxTempSensor1_tempC_1_offset = 2468;
	public static final int auxTempSensor1_tempC_2_offset = 2472;
	public static final int auxTempSensor1_tempC_3_offset = 2476;
	public static final int auxTempSensor2_adcChannel_offset = 2528;
	public static final int auxTempSensor2_alignmentFill_offset = 2529;
	public static final int auxTempSensor2_bias_resistor_offset = 2524;
	public static final int auxTempSensor2_config_offset = 2500;
	public static final int auxTempSensor2_offset = 2500;
	public static final int auxTempSensor2_resistance_1_offset = 2512;
	public static final int auxTempSensor2_resistance_2_offset = 2516;
	public static final int auxTempSensor2_resistance_3_offset = 2520;
	public static final int auxTempSensor2_tempC_1_offset = 2500;
	public static final int auxTempSensor2_tempC_2_offset = 2504;
	public static final int auxTempSensor2_tempC_3_offset = 2508;
	public static final int auxValves1_offset = 1836;
	public static final int auxValves2_offset = 1837;
	public static final int BARO_CORR_SIZE = 4;
	public static final int baroCorrPressureBins_offset = 1564;
	public static final int baroCorrRpmBins_offset = 1580;
	public static final int baroCorrTable_offset = 1596;
	...
	public static final int binarySerialRxPin_offset = 1835;
	public static final int binarySerialTxPin_offset = 1834;
	public static final int biQuad_a0_offset = 2356;
	public static final int biQuad_a0_offset_hex = 934;
	public static final int biQuad_a1_offset = 2360;
	public static final int biQuad_a1_offset_hex = 938;
	public static final int biQuad_a2_offset = 2364;
	public static final int biQuad_b1_offset = 2368;
	public static final int biQuad_b1_offset_hex = 940;
	public static final int biQuad_b2_offset = 2372;
	public static final int biQuad_b2_offset_hex = 944;
	public static final int biQuad_offset = 2356;
	public static final int biQuad_offset_hex = 934;
	public static final int BLOCKING_FACTOR = 400;
	public static final int boardTestModeJumperPin_offset = 710;
	public static final int boostCutPressure_offset = 2152;
	public static final int boostCutPressure_offset_hex = 868;
	public static final int brakePedalPin_offset = 2632;
	public static final int brakePedalPinMode_offset = 2635;
	public static final int byFirmwareVersion_offset = 500;
	public static final int camInput_offset = 2244;
	...
	public static final int cj125CsPinMode_offset = 2245;
	public static final int cj125isLsu49_offset = 76;
	public static final int cj125isUaDivided_offset = 76;
	public static final int cj125SpiDevice_offset = 2284;
	public static final int cj125ua_offset = 2633;
	public static final int cj125ur_offset = 2634;
	...
	public static final int cltIdleRpm_offset = 1980;
	public static final int cltIdleRpmBins_offset = 1916;
	public static final int cltTimingBins_offset = 2376;
	public static final int cltTimingBins_offset_hex = 948;
	public static final int cltTimingExtra_offset = 2408;
	...
	public static final int coastingFuelCutMap_offset = 3182;
	public static final int coastingFuelCutRpmHigh_offset = 3172;
	public static final int coastingFuelCutRpmLow_offset = 3174;
	...
	public static final int consoleSerialTxPin_offset = 1838;
	public static final int consoleUartDevice_offset = 808;
	public static final int consoleUartDevice_offset_hex = 328;
	...
	public static final int crankingIACposition_offset = 2248;
	public static final int crankingInjectionMode_offset = 424;
	public static final int crankingTimingAngle_offset = 436;
	public static final int crankingTpsBins_offset = 1692;
	public static final int crankingTpsCoef_offset = 1660;
	...
	public static final int debugMode_offset = 2112;
	public static final int debugMode_offset_hex = 840;
	...
	public static final int dizzySparkOutputPin_offset = 2246;
	public static final int dizzySparkOutputPinMode_offset = 2247;
	public static final int DWELL_CURVE_SIZE = 8;
	public static final int egoValueShift_offset = 2236;
	...
	public static final int engineLoadAccelEnrichmentMultiplier_offset = 2092;
	public static final int engineLoadAccelEnrichmentThreshold_offset = 2088;
	public static final int engineLoadAccelEnrichmentThreshold_offset_hex = 828;
	public static final int engineLoadAccelLength_offset = 2076;
	public static final int engineLoadDecelEnleanmentMultiplier_offset = 2084;
	public static final int engineLoadDecelEnleanmentMultiplier_offset_hex = 824;
	public static final int engineLoadDecelEnleanmentThreshold_offset = 2080;
	public static final int engineLoadDecelEnleanmentThreshold_offset_hex = 820;
	...
	public static final int etb_maxValue_offset = 1774;
	public static final int etb_minValue_offset = 1772;
	public static final int etb_offset = 1756;
	public static final int etb_offset_offset = 1768;
	public static final int etb_periodMs_offset = 1770;
	public static final int etb_pFactor_offset = 1756;
	...
	public static final int fatalErrorPin_offset = 2060;
	...
	public static final int fixedTiming_offset = 2224;
	public static final int flexFuelSensor_offset = 3124;
	...
	public static final int fsioAdc1_offset = 2220;
	public static final int fsioAdc2_offset = 2221;
	public static final int fsioAdc3_offset = 2222;
	public static final int fsioAdc4_offset = 2223;
	public static final int fsioCurve1_offset = 2804;
	public static final int fsioCurve1Bins_offset = 2740;
	public static final int fsioCurve2_offset = 2932;
	public static final int fsioCurve2Bins_offset = 2868;
	public static final int fsioCurve3_offset = 3028;
	public static final int fsioCurve3Bins_offset = 2996;
	public static final int fsioCurve4_offset = 3092;
	public static final int fsioCurve4Bins_offset = 3060;
	...
	public static final int fsioInputModes10_offset = 1533;
	public static final int fsioInputModes11_offset = 1534;
	public static final int fsioInputModes12_offset = 1535;
	public static final int fsioInputModes13_offset = 1536;
	public static final int fsioInputModes13_offset_hex = 600;
	public static final int fsioInputModes14_offset = 1537;
	public static final int fsioInputModes14_offset_hex = 601;
	public static final int fsioInputModes15_offset = 1538;
	public static final int fsioInputModes15_offset_hex = 602;
	public static final int fsioInputModes16_offset = 1539;
	public static final int fsioInputModes16_offset_hex = 603;
	public static final int fsioInputModes1_offset = 1524;
	public static final int fsioInputModes2_offset = 1525;
	public static final int fsioInputModes3_offset = 1526;
	public static final int fsioInputModes4_offset = 1527;
	public static final int fsioInputModes5_offset = 1528;
	public static final int fsioInputModes6_offset = 1529;
	public static final int fsioInputModes7_offset = 1530;
	public static final int fsioInputModes8_offset = 1531;
	public static final int fsioInputModes9_offset = 1532;
	...
	public static final int fuelClosedLoopAfrHighThreshold_offset = 2560;
	public static final int fuelClosedLoopAfrLowThreshold_offset = 696;
	public static final int fuelClosedLoopCltThreshold_offset = 2532;
	public static final int fuelClosedLoopCorrectionEnabled_offset = 1464;
	public static final int fuelClosedLoopPid_dFactor_offset = 2548;
	public static final int fuelClosedLoopPid_iFactor_offset = 2544;
	public static final int fuelClosedLoopPid_maxValue_offset = 2558;
	public static final int fuelClosedLoopPid_minValue_offset = 2556;
	public static final int fuelClosedLoopPid_offset = 2540;
	public static final int fuelClosedLoopPid_offset_offset = 2552;
	public static final int fuelClosedLoopPid_periodMs_offset = 2554;
	public static final int fuelClosedLoopPid_pFactor_offset = 2540;
	public static final int fuelClosedLoopRpmThreshold_offset = 2536;
	public static final int fuelClosedLoopTpsThreshold_offset = 2534;
	...
	public static final int iacByTpsTaper_offset = 2058;
	public static final int iacCoasting_offset = 3248;
	public static final int iacCoastingBins_offset = 3184;
	...
	public static final int idlePidRpmDeadZone_offset = 1914;
	public static final int idlePidRpmUpperLimit_offset = 1484;
	public static final int idleRpmPid_dFactor_offset = 1816;
	public static final int idleRpmPid_dFactor_offset_hex = 718;
	public static final int idleRpmPid_iFactor_offset = 1812;
	public static final int idleRpmPid_iFactor_offset_hex = 714;
	public static final int idleRpmPid_maxValue_offset = 1826;
	public static final int idleRpmPid_maxValue_offset_hex = 722;
	public static final int idleRpmPid_minValue_offset = 1824;
	public static final int idleRpmPid_minValue_offset_hex = 720;
	public static final int idleRpmPid_offset = 1808;
	public static final int idleRpmPid_offset_hex = 710;
	public static final int idleRpmPid_offset_offset = 1820;
	public static final int idleRpmPid_periodMs_offset = 1822;
	public static final int idleRpmPid_pFactor_offset = 1808;
	public static final int idleRpmPid_pFactor_offset_hex = 710;
	public static final int idleStepperReactionTime_offset = 1516;
	public static final int idleStepperTotalSteps_offset = 1552;
	public static final int idleStepperTotalSteps_offset_hex = 610;
	...
	public static final int ignitionTpsBins_offset = 3824;
	public static final int ignitionTpsTable_offset = 3312;
	public static final int ignMathCalculateAtIndex_offset = 1492;
	...
	public static final int knockDetectionWindowEnd_offset = 1512;
	public static final int knockDetectionWindowStart_offset = 1508;
	public static final int knockNoise_offset = 1840;
	public static final int knockNoise_offset_hex = 730;
	public static final int knockNoiseRpmBins_offset = 1872;
	...
	public static final int mapAccelTaperBins_offset = 2156;
	public static final int mapAccelTaperMult_offset = 2188;
	public static final int mapAveragingSchedulingAtIndex_offset = 1560;
	public static final int mapAveragingSchedulingAtIndex_offset_hex = 618;
	public static final int mapErrorDetectionTooHigh_offset = 1800;
	public static final int mapErrorDetectionTooHigh_offset_hex = 708;
	public static final int mapErrorDetectionTooLow_offset = 1796;
	public static final int mapErrorDetectionTooLow_offset_hex = 704;
	...
	public static final int mapHighValueVoltage_offset = 2232;
	public static final int mapLowValueVoltage_offset = 2228;
	...
	public static final int max31855spiDevice_offset = 804;
	...
	public static final int noAccelAfterHardLimitPeriodSecs_offset = 1556;
	public static final int noAccelAfterHardLimitPeriodSecs_offset_hex = 614;
	public static final int o2heaterPin_offset = 742;
	public static final int o2heaterPinModeTodO_offset = 743;
	public static final int oilPressure_align_offset = 2717;
	public static final int oilPressure_hwChannel_offset = 2716;
	public static final int oilPressure_offset = 2716;
	public static final int oilPressure_v1_offset = 2720;
	public static final int oilPressure_v2_offset = 2728;
	public static final int oilPressure_value1_offset = 2724;
	public static final int oilPressure_value2_offset = 2732;
	...
	public static final int postCrankingTargetClt_offset = 2456;
	public static final int postCrankingTargetClt_offset_hex = 998;
	...
	public static final int sdCardSpiDevice_offset = 2616;
	...
	public static final int servoOutputPins2_offset = 3165;
	public static final int servoOutputPins3_offset = 3166;
	public static final int servoOutputPins4_offset = 3167;
	public static final int servoOutputPins5_offset = 3168;
	...
	public static final int spi1MisoMode_offset = 2622;
	public static final int spi1misoPin_offset = 929;
	public static final int spi1MosiMode_offset = 2621;
	public static final int spi1mosiPin_offset = 928;
	public static final int spi1SckMode_offset = 2620;
	public static final int spi1sckPin_offset = 930;
	public static final int spi2MisoMode_offset = 2625;
	public static final int spi2misoPin_offset = 932;
	public static final int spi2MosiMode_offset = 2624;
	public static final int spi2mosiPin_offset = 931;
	public static final int spi2SckMode_offset = 2623;
	public static final int spi2sckPin_offset = 933;
	public static final int spi3MisoMode_offset = 2628;
	public static final int spi3misoPin_offset = 935;
	public static final int spi3MosiMode_offset = 2627;
	public static final int spi3mosiPin_offset = 934;
	public static final int spi3SckMode_offset = 2626;
	public static final int spi3sckPin_offset = 936;
	public static final int startOfCrankingPrimingPulse_offset = 2052;
	public static final int startOfCrankingPrimingPulse_offset_hex = 804;
	public static final int startUpFuelPumpDuration_offset = 1912;
	public static final int startUpFuelPumpDuration_offset_hex = 778;
	public static final int step1fuelCutEnable_offset = 1464;
	public static final int step1rpm_offset = 316;
	public static final int step1RpmWindow_offset = 1804;
	...
	public static final int stepperEnablePinMode_offset = 2629;
	...
	public static final int storageMode_offset = 2280;
	public static final int tachOutputPin_offset = 704;
	public static final int tachOutputPinMode_offset = 705;
	public static final int tachPulseDuractionMs_offset = 1724;
	public static final int tachPulseDurationAsDutyCycle_offset = 1464;
	public static final int tachPulseTriggerIndex_offset = 1728;
	public static final int targetVBatt_offset = 2044;
	public static final int tChargeAirCoefMax_offset = 3892;
	public static final int tChargeAirCoefMin_offset = 3888;
	public static final int tChargeAirDecrLimit_offset = 3904;
	public static final int tChargeAirFlowMax_offset = 3896;
	public static final int tChargeAirIncrLimit_offset = 3900;
	public static final int tChargeMaxRpmMaxTps_offset = 2264;
	public static final int tChargeMaxRpmMinTps_offset = 2260;
	public static final int tChargeMinRpmMaxTps_offset = 2256;
	public static final int tChargeMinRpmMinTps_offset = 2252;
	public static final int tChargeMode_offset = 3908;
	public static final int test557pin_offset = 3125;
	...
	public static final int throttlePedalUpVoltage_offset = 1904;
	public static final int throttlePedalUpVoltage_offset_hex = 770;
	public static final int throttlePedalWOTVoltage_offset = 1908;
	public static final int throttlePedalWOTVoltage_offset_hex = 774;
	public static final int timing_offset_cylinder10_offset = 2600;
	public static final int timing_offset_cylinder11_offset = 2604;
	public static final int timing_offset_cylinder12_offset = 2608;
	public static final int timing_offset_cylinder1_offset = 2564;
	public static final int timing_offset_cylinder2_offset = 2568;
	public static final int timing_offset_cylinder3_offset = 2572;
	public static final int timing_offset_cylinder4_offset = 2576;
	public static final int timing_offset_cylinder5_offset = 2580;
	public static final int timing_offset_cylinder6_offset = 2584;
	public static final int timing_offset_cylinder7_offset = 2588;
	public static final int timing_offset_cylinder8_offset = 2592;
	public static final int timing_offset_cylinder9_offset = 2596;
	...
	public static final int tpsDecelEnleanmentThreshold_offset_hex = 834;
	...
	public static final int vRefAdcChannel_offset = 1504;
	public static final int vvtCamSensorUseRise_offset = 744;
	public static final int vvtDisplayInverted_offset = 1464;
	public static final int vvtMode_offset = 2352;
	public static final int vvtMode_offset_hex = 930;
	public static final int vvtOffset_offset = 2072;
	public static final int vvtOffset_offset_hex = 818;
	public static final int WARMUP_TARGET_AFR_SIZE = 4;
	public static final int warmupAfrPid_dFactor_offset = 1784;
	public static final int warmupAfrPid_iFactor_offset = 1780;
	public static final int warmupAfrPid_maxValue_offset = 1794;
	public static final int warmupAfrPid_maxValue_offset_hex = 702;
	public static final int warmupAfrPid_minValue_offset = 1792;
	public static final int warmupAfrPid_minValue_offset_hex = 700;
	public static final int warmupAfrPid_offset = 1776;
	public static final int warmupAfrPid_offset_offset = 1788;
	public static final int warmupAfrPid_periodMs_offset = 1790;
	public static final int warmupAfrPid_pFactor_offset = 1776;
	public static final int warmupAfrThreshold_offset = 2148;
	public static final int warmupAfrThreshold_offset_hex = 864;
	public static final int warmupTargetAfr_offset = 2132;
	public static final int warmupTargetAfr_offset_hex = 854;
	public static final int warmupTargetAfrBins_offset = 2116;
	public static final int warmupTargetAfrBins_offset_hex = 844;
	public static final int warningLedPin_offset = 2061;
	public static final int warningPeriod_offset = 1502;
	public static final int wboHeaterPin_offset = 673;
	public static final int wwaeBeta_offset = 1828;
	public static final int wwaeBeta_offset_hex = 724;
	public static final int wwaeTau_offset = 1732;
	...
	public static final Field MAX31855SPIDEVICE = Field.create("MAX31855SPIDEVICE", 804, FieldType.INT8);
	public static final Field CONSOLEUARTDEVICE = Field.create("CONSOLEUARTDEVICE", 808, FieldType.INT8);
	...
	public static final Field ACSWITCHADC = Field.create("ACSWITCHADC", 1488, FieldType.INT8, adc_channel_e);
	public static final Field IGNMATHCALCULATEATINDEX = Field.create("IGNMATHCALCULATEATINDEX", 1492, FieldType.INT);
	public static final Field ACCUTOFFLOWRPM = Field.create("ACCUTOFFLOWRPM", 1496, FieldType.INT16);
	public static final Field ACCUTOFFHIGHRPM = Field.create("ACCUTOFFHIGHRPM", 1498, FieldType.INT16);
	public static final Field ACIDLERPMBUMP = Field.create("ACIDLERPMBUMP", 1500, FieldType.INT16);
	public static final Field WARNINGPERIOD = Field.create("WARNINGPERIOD", 1502, FieldType.INT16);
	public static final Field VREFADCCHANNEL = Field.create("VREFADCCHANNEL", 1504, FieldType.INT8, adc_channel_e);
	public static final Field KNOCKDETECTIONWINDOWSTART = Field.create("KNOCKDETECTIONWINDOWSTART", 1508, FieldType.FLOAT);
	public static final Field KNOCKDETECTIONWINDOWEND = Field.create("KNOCKDETECTIONWINDOWEND", 1512, FieldType.FLOAT);
	public static final Field IDLESTEPPERREACTIONTIME = Field.create("IDLESTEPPERREACTIONTIME", 1516, FieldType.FLOAT);
	public static final Field KNOCKVTHRESHOLD = Field.create("KNOCKVTHRESHOLD", 1520, FieldType.FLOAT);
	public static final Field FSIOINPUTMODES1 = Field.create("FSIOINPUTMODES1", 1524, FieldType.INT8);
	public static final Field FSIOINPUTMODES2 = Field.create("FSIOINPUTMODES2", 1525, FieldType.INT8);
	public static final Field FSIOINPUTMODES3 = Field.create("FSIOINPUTMODES3", 1526, FieldType.INT8);
	public static final Field FSIOINPUTMODES4 = Field.create("FSIOINPUTMODES4", 1527, FieldType.INT8);
	public static final Field FSIOINPUTMODES5 = Field.create("FSIOINPUTMODES5", 1528, FieldType.INT8);
	public static final Field FSIOINPUTMODES6 = Field.create("FSIOINPUTMODES6", 1529, FieldType.INT8);
	public static final Field FSIOINPUTMODES7 = Field.create("FSIOINPUTMODES7", 1530, FieldType.INT8);
	public static final Field FSIOINPUTMODES8 = Field.create("FSIOINPUTMODES8", 1531, FieldType.INT8);
	public static final Field FSIOINPUTMODES9 = Field.create("FSIOINPUTMODES9", 1532, FieldType.INT8);
	public static final Field FSIOINPUTMODES10 = Field.create("FSIOINPUTMODES10", 1533, FieldType.INT8);
	public static final Field FSIOINPUTMODES11 = Field.create("FSIOINPUTMODES11", 1534, FieldType.INT8);
	public static final Field FSIOINPUTMODES12 = Field.create("FSIOINPUTMODES12", 1535, FieldType.INT8);
	public static final Field FSIOINPUTMODES13 = Field.create("FSIOINPUTMODES13", 1536, FieldType.INT8);
	public static final Field FSIOINPUTMODES14 = Field.create("FSIOINPUTMODES14", 1537, FieldType.INT8);
	public static final Field FSIOINPUTMODES15 = Field.create("FSIOINPUTMODES15", 1538, FieldType.INT8);
	public static final Field FSIOINPUTMODES16 = Field.create("FSIOINPUTMODES16", 1539, FieldType.INT8);
	public static final Field IDLESTEPPERTOTALSTEPS = Field.create("IDLESTEPPERTOTALSTEPS", 1552, FieldType.INT);
	public static final Field NOACCELAFTERHARDLIMITPERIODSECS = Field.create("NOACCELAFTERHARDLIMITPERIODSECS", 1556, FieldType.FLOAT);
	public static final Field MAPAVERAGINGSCHEDULINGATINDEX = Field.create("MAPAVERAGINGSCHEDULINGATINDEX", 1560, FieldType.INT);
	public static final Field BAROCORRTABLE = Field.create("BAROCORRTABLE", 1596, FieldType.INT);
	public static final Field TACHPULSEDURACTIONMS = Field.create("TACHPULSEDURACTIONMS", 1724, FieldType.FLOAT);
	public static final Field TACHPULSETRIGGERINDEX = Field.create("TACHPULSETRIGGERINDEX", 1728, FieldType.INT);
	public static final Field WWAETAU = Field.create("WWAETAU", 1732, FieldType.FLOAT);
	public static final Field ALTERNATORCONTROL_PFACTOR = Field.create("ALTERNATORCONTROL_PFACTOR", 1736, FieldType.FLOAT);
	public static final Field ALTERNATORCONTROL_IFACTOR = Field.create("ALTERNATORCONTROL_IFACTOR", 1740, FieldType.FLOAT);
	public static final Field ALTERNATORCONTROL_DFACTOR = Field.create("ALTERNATORCONTROL_DFACTOR", 1744, FieldType.FLOAT);
	public static final Field ALTERNATORCONTROL_OFFSET = Field.create("ALTERNATORCONTROL_OFFSET", 1748, FieldType.INT16);
	public static final Field ALTERNATORCONTROL_PERIODMS = Field.create("ALTERNATORCONTROL_PERIODMS", 1750, FieldType.INT16);
	public static final Field ALTERNATORCONTROL_MINVALUE = Field.create("ALTERNATORCONTROL_MINVALUE", 1752, FieldType.INT16);
	public static final Field ALTERNATORCONTROL_MAXVALUE = Field.create("ALTERNATORCONTROL_MAXVALUE", 1754, FieldType.INT16);
	public static final Field ETB_PFACTOR = Field.create("ETB_PFACTOR", 1756, FieldType.FLOAT);
	public static final Field ETB_IFACTOR = Field.create("ETB_IFACTOR", 1760, FieldType.FLOAT);
	public static final Field ETB_DFACTOR = Field.create("ETB_DFACTOR", 1764, FieldType.FLOAT);
	public static final Field ETB_OFFSET = Field.create("ETB_OFFSET", 1768, FieldType.INT16);
	public static final Field ETB_PERIODMS = Field.create("ETB_PERIODMS", 1770, FieldType.INT16);
	public static final Field ETB_MINVALUE = Field.create("ETB_MINVALUE", 1772, FieldType.INT16);
	public static final Field ETB_MAXVALUE = Field.create("ETB_MAXVALUE", 1774, FieldType.INT16);
	public static final Field WARMUPAFRPID_PFACTOR = Field.create("WARMUPAFRPID_PFACTOR", 1776, FieldType.FLOAT);
	public static final Field WARMUPAFRPID_IFACTOR = Field.create("WARMUPAFRPID_IFACTOR", 1780, FieldType.FLOAT);
	public static final Field WARMUPAFRPID_DFACTOR = Field.create("WARMUPAFRPID_DFACTOR", 1784, FieldType.FLOAT);
	public static final Field WARMUPAFRPID_OFFSET = Field.create("WARMUPAFRPID_OFFSET", 1788, FieldType.INT16);
	public static final Field WARMUPAFRPID_PERIODMS = Field.create("WARMUPAFRPID_PERIODMS", 1790, FieldType.INT16);
	public static final Field WARMUPAFRPID_MINVALUE = Field.create("WARMUPAFRPID_MINVALUE", 1792, FieldType.INT16);
	public static final Field WARMUPAFRPID_MAXVALUE = Field.create("WARMUPAFRPID_MAXVALUE", 1794, FieldType.INT16);
	public static final Field MAPERRORDETECTIONTOOLOW = Field.create("MAPERRORDETECTIONTOOLOW", 1796, FieldType.FLOAT);
	public static final Field MAPERRORDETECTIONTOOHIGH = Field.create("MAPERRORDETECTIONTOOHIGH", 1800, FieldType.FLOAT);
	public static final Field STEP1RPMWINDOW = Field.create("STEP1RPMWINDOW", 1804, FieldType.INT);
	public static final Field IDLERPMPID_PFACTOR = Field.create("IDLERPMPID_PFACTOR", 1808, FieldType.FLOAT);
	public static final Field IDLERPMPID_IFACTOR = Field.create("IDLERPMPID_IFACTOR", 1812, FieldType.FLOAT);
	public static final Field IDLERPMPID_DFACTOR = Field.create("IDLERPMPID_DFACTOR", 1816, FieldType.FLOAT);
	public static final Field IDLERPMPID_OFFSET = Field.create("IDLERPMPID_OFFSET", 1820, FieldType.INT16);
	public static final Field IDLERPMPID_PERIODMS = Field.create("IDLERPMPID_PERIODMS", 1822, FieldType.INT16);
	public static final Field IDLERPMPID_MINVALUE = Field.create("IDLERPMPID_MINVALUE", 1824, FieldType.INT16);
	public static final Field IDLERPMPID_MAXVALUE = Field.create("IDLERPMPID_MAXVALUE", 1826, FieldType.INT16);
	public static final Field WWAEBETA = Field.create("WWAEBETA", 1828, FieldType.FLOAT);
	public static final Field COMMUNICATIONLEDPIN = Field.create("COMMUNICATIONLEDPIN", 1832, FieldType.INT8, brain_pin_e);
	public static final Field RUNNINGLEDPIN = Field.create("RUNNINGLEDPIN", 1833, FieldType.INT8, brain_pin_e);
	public static final Field BINARYSERIALTXPIN = Field.create("BINARYSERIALTXPIN", 1834, FieldType.INT8, brain_pin_e);
	public static final Field BINARYSERIALRXPIN = Field.create("BINARYSERIALRXPIN", 1835, FieldType.INT8, brain_pin_e);
	public static final Field AUXVALVES1 = Field.create("AUXVALVES1", 1836, FieldType.INT8, brain_pin_e);
	public static final Field AUXVALVES2 = Field.create("AUXVALVES2", 1837, FieldType.INT8, brain_pin_e);
	public static final Field CONSOLESERIALTXPIN = Field.create("CONSOLESERIALTXPIN", 1838, FieldType.INT8, brain_pin_e);
	public static final Field CONSOLESERIALRXPIN = Field.create("CONSOLESERIALRXPIN", 1839, FieldType.INT8, brain_pin_e);
	public static final Field THROTTLEPEDALUPVOLTAGE = Field.create("THROTTLEPEDALUPVOLTAGE", 1904, FieldType.FLOAT);
	public static final Field THROTTLEPEDALWOTVOLTAGE = Field.create("THROTTLEPEDALWOTVOLTAGE", 1908, FieldType.FLOAT);
	public static final Field STARTUPFUELPUMPDURATION = Field.create("STARTUPFUELPUMPDURATION", 1912, FieldType.INT16);
	public static final Field IDLEPIDRPMDEADZONE = Field.create("IDLEPIDRPMDEADZONE", 1914, FieldType.INT16);
	public static final Field TARGETVBATT = Field.create("TARGETVBATT", 2044, FieldType.FLOAT);
	public static final Field ALTERNATOROFFABOVETPS = Field.create("ALTERNATOROFFABOVETPS", 2048, FieldType.FLOAT);
	public static final Field STARTOFCRANKINGPRIMINGPULSE = Field.create("STARTOFCRANKINGPRIMINGPULSE", 2052, FieldType.FLOAT);
	public static final Field AFTERCRANKINGIACTAPERDURATION = Field.create("AFTERCRANKINGIACTAPERDURATION", 2056, FieldType.INT16);
	...
	public static final Field WARNINGLEDPIN = Field.create("WARNINGLEDPIN", 2061, FieldType.INT8, brain_pin_e);
	...
	public static final Field VVTOFFSET = Field.create("VVTOFFSET", 2072, FieldType.FLOAT);
	public static final Field ENGINELOADACCELLENGTH = Field.create("ENGINELOADACCELLENGTH", 2076, FieldType.INT);
	public static final Field ENGINELOADDECELENLEANMENTTHRESHOLD = Field.create("ENGINELOADDECELENLEANMENTTHRESHOLD", 2080, FieldType.FLOAT);
	public static final Field ENGINELOADDECELENLEANMENTMULTIPLIER = Field.create("ENGINELOADDECELENLEANMENTMULTIPLIER", 2084, FieldType.FLOAT);
	public static final Field ENGINELOADACCELENRICHMENTTHRESHOLD = Field.create("ENGINELOADACCELENRICHMENTTHRESHOLD", 2088, FieldType.FLOAT);
	public static final Field ENGINELOADACCELENRICHMENTMULTIPLIER = Field.create("ENGINELOADACCELENRICHMENTMULTIPLIER", 2092, FieldType.FLOAT);
	public static final Field UARTCONSOLESERIALSPEED = Field.create("UARTCONSOLESERIALSPEED", 2096, FieldType.INT);
	...
	public static final Field FSIOADC1 = Field.create("FSIOADC1", 2220, FieldType.INT8, adc_channel_e);
	...
	public static final Field FIXEDTIMING = Field.create("FIXEDTIMING", 2224, FieldType.FLOAT);
	...
	public static final Field DIZZYSPARKOUTPUTPINMODE = Field.create("DIZZYSPARKOUTPUTPINMODE", 2247, FieldType.INT8, pin_output_mode_e);
	public static final Field CRANKINGIACPOSITION = Field.create("CRANKINGIACPOSITION", 2248, FieldType.INT);
	public static final Field TCHARGEMINRPMMINTPS = Field.create("TCHARGEMINRPMMINTPS", 2252, FieldType.FLOAT);
	public static final Field TCHARGEMINRPMMAXTPS = Field.create("TCHARGEMINRPMMAXTPS", 2256, FieldType.FLOAT);
	public static final Field TCHARGEMAXRPMMINTPS = Field.create("TCHARGEMAXRPMMINTPS", 2260, FieldType.FLOAT);
	public static final Field TCHARGEMAXRPMMAXTPS = Field.create("TCHARGEMAXRPMMAXTPS", 2264, FieldType.FLOAT);
	public static final Field AUXPIDFREQUENCY1 = Field.create("AUXPIDFREQUENCY1", 2268, FieldType.INT16);
	public static final Field AUXPIDFREQUENCY2 = Field.create("AUXPIDFREQUENCY2", 2270, FieldType.INT16);
	public static final Field AUXPIDFREQUENCY3 = Field.create("AUXPIDFREQUENCY3", 2272, FieldType.INT16);
	public static final Field AUXPIDFREQUENCY4 = Field.create("AUXPIDFREQUENCY4", 2274, FieldType.INT16);
	public static final Field ALTERNATORPWMFREQUENCY = Field.create("ALTERNATORPWMFREQUENCY", 2276, FieldType.INT);
	public static final String[] mass_storage_e = {"Auto", "Always", "Never"};
	public static final Field STORAGEMODE = Field.create("STORAGEMODE", 2280, FieldType.INT, mass_storage_e);
	public static final Field CJ125SPIDEVICE = Field.create("CJ125SPIDEVICE", 2284, FieldType.INT8);
	public static final String[] vvt_mode_e = {"First half", "Second half", "2GZ", "Miata NB2", "mode4", "mode5", "mode6", "mode7"};
	public static final Field VVTMODE = Field.create("VVTMODE", 2352, FieldType.INT, vvt_mode_e);
	public static final Field BIQUAD_A0 = Field.create("BIQUAD_A0", 2356, FieldType.FLOAT);
	public static final Field BIQUAD_A1 = Field.create("BIQUAD_A1", 2360, FieldType.FLOAT);
	public static final Field BIQUAD_A2 = Field.create("BIQUAD_A2", 2364, FieldType.FLOAT);
	public static final Field BIQUAD_B1 = Field.create("BIQUAD_B1", 2368, FieldType.FLOAT);
	public static final Field BIQUAD_B2 = Field.create("BIQUAD_B2", 2372, FieldType.FLOAT);
	public static final Field NBVVTINDEX = Field.create("NBVVTINDEX", 2440, FieldType.INT);
	public static final Field AUTOTUNECLTTHRESHOLD = Field.create("AUTOTUNECLTTHRESHOLD", 2444, FieldType.FLOAT);
	public static final Field AUTOTUNETPSROCTHRESHOLD = Field.create("AUTOTUNETPSROCTHRESHOLD", 2448, FieldType.FLOAT);
	public static final Field AUTOTUNETPSQUIETPERIOD = Field.create("AUTOTUNETPSQUIETPERIOD", 2452, FieldType.FLOAT);
	public static final Field POSTCRANKINGTARGETCLT = Field.create("POSTCRANKINGTARGETCLT", 2456, FieldType.FLOAT);
	public static final Field POSTCRANKINGFACTOR = Field.create("POSTCRANKINGFACTOR", 2460, FieldType.FLOAT);
	public static final Field POSTCRANKINGDURATIONSEC = Field.create("POSTCRANKINGDURATIONSEC", 2464, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_TEMPC_1 = Field.create("AUXTEMPSENSOR1_TEMPC_1", 2468, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_TEMPC_2 = Field.create("AUXTEMPSENSOR1_TEMPC_2", 2472, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_TEMPC_3 = Field.create("AUXTEMPSENSOR1_TEMPC_3", 2476, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_RESISTANCE_1 = Field.create("AUXTEMPSENSOR1_RESISTANCE_1", 2480, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_RESISTANCE_2 = Field.create("AUXTEMPSENSOR1_RESISTANCE_2", 2484, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_RESISTANCE_3 = Field.create("AUXTEMPSENSOR1_RESISTANCE_3", 2488, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_BIAS_RESISTOR = Field.create("AUXTEMPSENSOR1_BIAS_RESISTOR", 2492, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR1_ADCCHANNEL = Field.create("AUXTEMPSENSOR1_ADCCHANNEL", 2496, FieldType.INT8, adc_channel_e);
	public static final Field AUXTEMPSENSOR2_TEMPC_1 = Field.create("AUXTEMPSENSOR2_TEMPC_1", 2500, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_TEMPC_2 = Field.create("AUXTEMPSENSOR2_TEMPC_2", 2504, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_TEMPC_3 = Field.create("AUXTEMPSENSOR2_TEMPC_3", 2508, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_RESISTANCE_1 = Field.create("AUXTEMPSENSOR2_RESISTANCE_1", 2512, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_RESISTANCE_2 = Field.create("AUXTEMPSENSOR2_RESISTANCE_2", 2516, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_RESISTANCE_3 = Field.create("AUXTEMPSENSOR2_RESISTANCE_3", 2520, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_BIAS_RESISTOR = Field.create("AUXTEMPSENSOR2_BIAS_RESISTOR", 2524, FieldType.FLOAT);
	public static final Field AUXTEMPSENSOR2_ADCCHANNEL = Field.create("AUXTEMPSENSOR2_ADCCHANNEL", 2528, FieldType.INT8, adc_channel_e);
	public static final Field FUELCLOSEDLOOPCLTTHRESHOLD = Field.create("FUELCLOSEDLOOPCLTTHRESHOLD", 2532, FieldType.INT16);
	public static final Field FUELCLOSEDLOOPTPSTHRESHOLD = Field.create("FUELCLOSEDLOOPTPSTHRESHOLD", 2534, FieldType.INT16);
	public static final Field FUELCLOSEDLOOPRPMTHRESHOLD = Field.create("FUELCLOSEDLOOPRPMTHRESHOLD", 2536, FieldType.INT16);
	public static final Field ETBFREQ = Field.create("ETBFREQ", 2538, FieldType.INT16);
	public static final Field FUELCLOSEDLOOPPID_PFACTOR = Field.create("FUELCLOSEDLOOPPID_PFACTOR", 2540, FieldType.FLOAT);
	public static final Field FUELCLOSEDLOOPPID_IFACTOR = Field.create("FUELCLOSEDLOOPPID_IFACTOR", 2544, FieldType.FLOAT);
	public static final Field FUELCLOSEDLOOPPID_DFACTOR = Field.create("FUELCLOSEDLOOPPID_DFACTOR", 2548, FieldType.FLOAT);
	public static final Field FUELCLOSEDLOOPPID_OFFSET = Field.create("FUELCLOSEDLOOPPID_OFFSET", 2552, FieldType.INT16);
	public static final Field FUELCLOSEDLOOPPID_PERIODMS = Field.create("FUELCLOSEDLOOPPID_PERIODMS", 2554, FieldType.INT16);
	public static final Field FUELCLOSEDLOOPPID_MINVALUE = Field.create("FUELCLOSEDLOOPPID_MINVALUE", 2556, FieldType.INT16);
	public static final Field FUELCLOSEDLOOPPID_MAXVALUE = Field.create("FUELCLOSEDLOOPPID_MAXVALUE", 2558, FieldType.INT16);
	public static final Field FUELCLOSEDLOOPAFRHIGHTHRESHOLD = Field.create("FUELCLOSEDLOOPAFRHIGHTHRESHOLD", 2560, FieldType.FLOAT);
	public static final Field TIMING_OFFSET_CYLINDER1 = Field.create("TIMING_OFFSET_CYLINDER1", 2564, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER2 = Field.create("TIMING_OFFSET_CYLINDER2", 2568, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER3 = Field.create("TIMING_OFFSET_CYLINDER3", 2572, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER4 = Field.create("TIMING_OFFSET_CYLINDER4", 2576, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER5 = Field.create("TIMING_OFFSET_CYLINDER5", 2580, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER6 = Field.create("TIMING_OFFSET_CYLINDER6", 2584, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER7 = Field.create("TIMING_OFFSET_CYLINDER7", 2588, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER8 = Field.create("TIMING_OFFSET_CYLINDER8", 2592, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER9 = Field.create("TIMING_OFFSET_CYLINDER9", 2596, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER10 = Field.create("TIMING_OFFSET_CYLINDER10", 2600, FieldType.INT);
	public static final Field TIMING_OFFSET_CYLINDER11 = Field.create("TIMING_OFFSET_CYLINDER11", 2604, FieldType.INT);
	...
	public static final Field SDCARDSPIDEVICE = Field.create("SDCARDSPIDEVICE", 2616, FieldType.INT8);
	...
	public static final Field SPI1SCKMODE = Field.create("SPI1SCKMODE", 2620, FieldType.INT8, pin_mode_e);
	public static final Field SPI1MOSIMODE = Field.create("SPI1MOSIMODE", 2621, FieldType.INT8, pin_mode_e);
	public static final Field SPI1MISOMODE = Field.create("SPI1MISOMODE", 2622, FieldType.INT8, pin_mode_e);
	public static final Field SPI2SCKMODE = Field.create("SPI2SCKMODE", 2623, FieldType.INT8, pin_mode_e);
	public static final Field SPI2MOSIMODE = Field.create("SPI2MOSIMODE", 2624, FieldType.INT8, pin_mode_e);
	public static final Field SPI2MISOMODE = Field.create("SPI2MISOMODE", 2625, FieldType.INT8, pin_mode_e);
	public static final Field SPI3SCKMODE = Field.create("SPI3SCKMODE", 2626, FieldType.INT8, pin_mode_e);
	...
	public static final Field AUXPID1_PFACTOR = Field.create("AUXPID1_PFACTOR", 2636, FieldType.FLOAT);
	public static final Field AUXPID1_IFACTOR = Field.create("AUXPID1_IFACTOR", 2640, FieldType.FLOAT);
	public static final Field AUXPID1_DFACTOR = Field.create("AUXPID1_DFACTOR", 2644, FieldType.FLOAT);
	public static final Field AUXPID1_OFFSET = Field.create("AUXPID1_OFFSET", 2648, FieldType.INT16);
	public static final Field AUXPID1_PERIODMS = Field.create("AUXPID1_PERIODMS", 2650, FieldType.INT16);
	public static final Field AUXPID1_MINVALUE = Field.create("AUXPID1_MINVALUE", 2652, FieldType.INT16);
	public static final Field AUXPID1_MAXVALUE = Field.create("AUXPID1_MAXVALUE", 2654, FieldType.INT16);
	public static final Field AUXPID2_PFACTOR = Field.create("AUXPID2_PFACTOR", 2656, FieldType.FLOAT);
	public static final Field AUXPID2_IFACTOR = Field.create("AUXPID2_IFACTOR", 2660, FieldType.FLOAT);
	public static final Field AUXPID2_DFACTOR = Field.create("AUXPID2_DFACTOR", 2664, FieldType.FLOAT);
	public static final Field AUXPID2_OFFSET = Field.create("AUXPID2_OFFSET", 2668, FieldType.INT16);
	public static final Field AUXPID2_PERIODMS = Field.create("AUXPID2_PERIODMS", 2670, FieldType.INT16);
	public static final Field AUXPID2_MINVALUE = Field.create("AUXPID2_MINVALUE", 2672, FieldType.INT16);
	public static final Field AUXPID2_MAXVALUE = Field.create("AUXPID2_MAXVALUE", 2674, FieldType.INT16);
	public static final Field AUXPID3_PFACTOR = Field.create("AUXPID3_PFACTOR", 2676, FieldType.FLOAT);
	public static final Field AUXPID3_IFACTOR = Field.create("AUXPID3_IFACTOR", 2680, FieldType.FLOAT);
	public static final Field AUXPID3_DFACTOR = Field.create("AUXPID3_DFACTOR", 2684, FieldType.FLOAT);
	public static final Field AUXPID3_OFFSET = Field.create("AUXPID3_OFFSET", 2688, FieldType.INT16);
	public static final Field AUXPID3_PERIODMS = Field.create("AUXPID3_PERIODMS", 2690, FieldType.INT16);
	public static final Field AUXPID3_MINVALUE = Field.create("AUXPID3_MINVALUE", 2692, FieldType.INT16);
	public static final Field AUXPID3_MAXVALUE = Field.create("AUXPID3_MAXVALUE", 2694, FieldType.INT16);
	public static final Field AUXPID4_PFACTOR = Field.create("AUXPID4_PFACTOR", 2696, FieldType.FLOAT);
	public static final Field AUXPID4_IFACTOR = Field.create("AUXPID4_IFACTOR", 2700, FieldType.FLOAT);
	public static final Field AUXPID4_DFACTOR = Field.create("AUXPID4_DFACTOR", 2704, FieldType.FLOAT);
	public static final Field AUXPID4_OFFSET = Field.create("AUXPID4_OFFSET", 2708, FieldType.INT16);
	public static final Field AUXPID4_PERIODMS = Field.create("AUXPID4_PERIODMS", 2710, FieldType.INT16);
	public static final Field AUXPID4_MINVALUE = Field.create("AUXPID4_MINVALUE", 2712, FieldType.INT16);
	public static final Field AUXPID4_MAXVALUE = Field.create("AUXPID4_MAXVALUE", 2714, FieldType.INT16);
	public static final Field OILPRESSURE_HWCHANNEL = Field.create("OILPRESSURE_HWCHANNEL", 2716, FieldType.INT8, adc_channel_e);
	public static final Field OILPRESSURE_V1 = Field.create("OILPRESSURE_V1", 2720, FieldType.FLOAT);
	public static final Field OILPRESSURE_VALUE1 = Field.create("OILPRESSURE_VALUE1", 2724, FieldType.FLOAT);
	public static final Field OILPRESSURE_V2 = Field.create("OILPRESSURE_V2", 2728, FieldType.FLOAT);
	public static final Field OILPRESSURE_VALUE2 = Field.create("OILPRESSURE_VALUE2", 2732, FieldType.FLOAT);
	public static final Field ACCELEROMETERSPIDEVICE = Field.create("ACCELEROMETERSPIDEVICE", 2736, FieldType.INT8);
	public static final Field FLEXFUELSENSOR = Field.create("FLEXFUELSENSOR", 3124, FieldType.INT8, brain_input_pin_e);
	public static final Field TEST557PIN = Field.create("TEST557PIN", 3125, FieldType.INT8, brain_pin_e);
	public static final Field STEPPERDIRECTIONPINMODE = Field.create("STEPPERDIRECTIONPINMODE", 3126, FieldType.INT8, pin_output_mode_e);
	public static final Field EXTERNALKNOCKSENSEADC = Field.create("EXTERNALKNOCKSENSEADC", 3127, FieldType.INT8, adc_channel_e);
	...
	public static final Field SERVOOUTPUTPINS4 = Field.create("SERVOOUTPUTPINS4", 3167, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS5 = Field.create("SERVOOUTPUTPINS5", 3168, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS6 = Field.create("SERVOOUTPUTPINS6", 3169, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS7 = Field.create("SERVOOUTPUTPINS7", 3170, FieldType.INT8, brain_pin_e);
	public static final Field SERVOOUTPUTPINS8 = Field.create("SERVOOUTPUTPINS8", 3171, FieldType.INT8, brain_pin_e);
	public static final Field COASTINGFUELCUTRPMHIGH = Field.create("COASTINGFUELCUTRPMHIGH", 3172, FieldType.INT16);
	public static final Field COASTINGFUELCUTRPMLOW = Field.create("COASTINGFUELCUTRPMLOW", 3174, FieldType.INT16);
	public static final Field COASTINGFUELCUTTPS = Field.create("COASTINGFUELCUTTPS", 3176, FieldType.INT16);
	public static final Field COASTINGFUELCUTCLT = Field.create("COASTINGFUELCUTCLT", 3178, FieldType.INT16);
	public static final Field PIDEXTRAFORLOWRPM = Field.create("PIDEXTRAFORLOWRPM", 3180, FieldType.INT16);
	public static final Field COASTINGFUELCUTMAP = Field.create("COASTINGFUELCUTMAP", 3182, FieldType.INT16);
	public static final Field IGNITIONTPSTABLE = Field.create("IGNITIONTPSTABLE", 3312, FieldType.INT);
	public static final Field TCHARGEAIRCOEFMIN = Field.create("TCHARGEAIRCOEFMIN", 3888, FieldType.FLOAT);
	public static final Field TCHARGEAIRCOEFMAX = Field.create("TCHARGEAIRCOEFMAX", 3892, FieldType.FLOAT);
	public static final Field TCHARGEAIRFLOWMAX = Field.create("TCHARGEAIRFLOWMAX", 3896, FieldType.FLOAT);
	public static final Field TCHARGEAIRINCRLIMIT = Field.create("TCHARGEAIRINCRLIMIT", 3900, FieldType.FLOAT);
	public static final Field TCHARGEAIRDECRLIMIT = Field.create("TCHARGEAIRDECRLIMIT", 3904, FieldType.FLOAT);
	...
	public static final Field ETB_ITERMMIN = Field.create("ETB_ITERMMIN", 3980, FieldType.INT16);
	public static final Field ETB_ITERMMAX = Field.create("ETB_ITERMMAX", 3982, FieldType.INT16);
	public static final Field ETBDEADBAND = Field.create("ETBDEADBAND", 3984, FieldType.FLOAT);
	public static final Field ETB2_DIRECTIONPIN1 = Field.create("ETB2_DIRECTIONPIN1", 3988, FieldType.INT8, brain_pin_e);
	public static final Field ETB2_DIRECTIONPIN2 = Field.create("ETB2_DIRECTIONPIN2", 3989, FieldType.INT8, brain_pin_e);
	public static final Field ETB2_CONTROLPIN1 = Field.create("ETB2_CONTROLPIN1", 3990, FieldType.INT8, brain_pin_e);
	public static final Field ETB2_CONTROLPIN2 = Field.create("ETB2_CONTROLPIN2", 3991, FieldType.INT8, brain_pin_e);
	...
	public static final Field IDLETIMINGPID_OFFSET = Field.create("IDLETIMINGPID_OFFSET", 4004, FieldType.INT16);
	public static final Field IDLETIMINGPID_PERIODMS = Field.create("IDLETIMINGPID_PERIODMS", 4006, FieldType.INT16);
	public static final Field IDLETIMINGPID_MINVALUE = Field.create("IDLETIMINGPID_MINVALUE", 4008, FieldType.INT16);
	public static final Field IDLETIMINGPID_MAXVALUE = Field.create("IDLETIMINGPID_MAXVALUE", 4010, FieldType.INT16);
	public static final Field IDLETIMINGPIDWORKZONE = Field.create("IDLETIMINGPIDWORKZONE", 4012, FieldType.INT16);
	public static final Field IDLETIMINGPIDDEADZONE = Field.create("IDLETIMINGPIDDEADZONE", 4014, FieldType.INT16);
	public static final Field IDLEPIDFALLOFFDELTARPM = Field.create("IDLEPIDFALLOFFDELTARPM", 4016, FieldType.INT16);
